                            ...
                            <div class="col-sm-6 mb-4">
                                <div class="card resume-card border-0 bg-dark">
                                    ...
                                    <h3 className='card-title'>2022-2025</h3>
                                        <h4 class="card-title">Bachelor's Degree of CSE</h4>
                                        <p>Dr. APJ Abdul Kalam University</p>
                                        <p class="card-text">Computer Science & Engineering Dr APJ Abdul Kalam Technical University, Lucknow U.P. India.</p>
                            ...
                            <div class="col-sm-6 mb-4">
                                ...
                                <div class="card-body">
                                    <h3 className='card-title'>2018-2021</h3>
                                        <h4 class="card-title">Diploma in computer Science</h4>
                                        <p>Board of Technical Education</p>
                                        <p class="card-text">Computer Science And Programming Board of Technical Education Lucknow U.P. India.</p>
