    ...
    return (
        <div className='service-section py-5'>
            ...
            <div className="row service-container justify-content-evenly p-3">
                <div className="col-sm-4 service-box"> <FontAwesomeIcon icon={faCode} className="custom-icon" /><br /> WEB DESIGN</div>
                <div className="col-sm-4 service-box"> <FontAwesomeIcon icon={faCode} className="custom-icon" /><br /> WEB DEVELOPING</div>
                <div className="col-sm-4 service-box"> <FontAwesomeIcon icon={faCode} className="custom-icon" /><br /> API DEVELOPER</div>
            </div>
        </div>
    );
}
